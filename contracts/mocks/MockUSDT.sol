...
contract TokenArchitecture is ERC20, ERC20Pausable, AccessControl, ERC20Permit {
    //NOTE: Deklarasi ERC20: Membuat token dengan nama "MockUSDT" dan inisial "MSDT"

    //NOTE: Deklarasi ERC20Permit: Tujuan dari ERC20Permit("Danny Token") di constructor adalah untuk menyetel nama token ke dalam DOMAIN_SEPARATOR, agar tanda tangan permit() hanya valid untuk kontrak dan chain tertentu, mencegah penyalahgunaan (replay attack), memastikan tanda tangan dapat diverifikasi dengan benar, serta dengan permit kita bisa mengizinkan orang lain memakai token kita tanpa harus menggunakan approve lalu transferform, jadinya hanya 1 transaksi saja
    ...
    constructor(
        address _treasury
    ) ERC20("MockUSDT", "MSDT") ERC20Permit("MockUSDT") {
